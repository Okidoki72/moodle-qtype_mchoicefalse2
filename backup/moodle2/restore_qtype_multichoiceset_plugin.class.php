...
/**
 * Restore handler for Moodle 2.x/3.x mchoiceftwo questions
 *
...
/**
 * Restore plugin class that provides the information needed to restore one mchoiceftwo qtype
 *
 * @copyright  2010 onwards Eloy Lafuente (stronk7) {@link http://stronk7.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qtype_mchoiceftwo_plugin extends restore_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        $elepath = $this->get_pathfor('/mchoiceftwo');
    ...
    /**
     * Process the qtype/mchoiceftwo element
     *
     * @param stdObject $data question data
     * @return void
     */
    public function process_mchoiceftwo($data) {
        global $DB;
        ...
        if ($questioncreated) {
            ...
            if (!$DB->record_exists('qtype_mchoiceftwo_options', array('questionid' => $data->questionid))) {
                $newitemid = $DB->insert_record('qtype_mchoiceftwo_options', $data);
                $this->set_mapping('qtype_mchoiceftwo_options', $oldid, $newitemid);
            }
        }
    }
     ...
     * recoded pointing to all the restored stuff for mchoiceftwo questions
     *
    ...
    public static function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('qtype_mchoiceftwo_options',
                $fields, 'qtype_mchoiceftwo_options');
