...
/**
 * Defines the editing form for the mchoicefalse2 question type.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_mchoicefalse2_edit_form extends question_edit_form {
    /**
    ...
    protected function get_per_answer_fields($mform, $label, $gradeoptions,
        ...
        $repeated[] = $mform->createElement('checkbox', 'correctanswer',
                get_string('correctanswer', 'qtype_mchoicefalse2'));
    ...
    protected function get_hint_fields($withclearwrong = false, $withshownumpartscorrect = false) {
        ...
        $repeated[] = $this->_form->createElement('advcheckbox', 'hintshowchoicefeedback', '',
                get_string('showeachanswerfeedback', 'qtype_mchoicefalse2'));
    ...
    public function validation($data, $files) {
        ...
        if ($numberofcorrectanswers == 0) {
            $errors['answer[0]'] = get_string('errnocorrect', 'qtype_mchoicefalse2');
        }
