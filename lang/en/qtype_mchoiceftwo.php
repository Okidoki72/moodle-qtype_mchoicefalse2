...
/**
 * Strings for component 'qtype_mchoiceftwo', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['pluginname_help'] = 'After an optional introduction, the respondent can choose one or more answers.  Unlike the multiple choice question, each selected correct choice will yield the fraction 1/ncorrect of points, each selected incorrect leads to –1/max(nwrong, 2) of points.';
$string['pluginname_link'] = 'question/type/mchoiceftwo';
